    ...
    return (
        <Formik
            ...
            validationSchema={object().shape({
                term: string().min(3, 'Veuillez saisir au moins trois caractères pour commencer la recherche.'),
            })}
                ...
                <Modal {...props}>
                    <Form>
                        <FormikFieldWrapper
                            ...
                            description={'Entrez un nom de serveur, uuid ou allocation pour commencer la recherche.'}
                        >
                            <SearchWatcher />
